...
public class PopUpManager : MonoBehaviour
{
    ...
    private Queue<string> popupQueue; // make it different type for more detailed popups, you can add different types, titles, description etc
    ...
    private void ShowPopUp(string text) // parameter the same type as queue 
    {
        ...
        popupText.text = text;
        popupAnimator.Play("pop_up_animation");
    }
